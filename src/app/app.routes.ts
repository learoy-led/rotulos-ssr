...
export const routes: Routes = [
    {
        ...
        data: {
          ...
          image: 'https://res.cloudinary.com/dxuseyfxa/image/upload/v1742550802/rotulo-luminoso-learoy_dgqanb.webp'
        }
      },
      {
        path: 'catalogo', 
        loadComponent: () => import('./pages/categorias/categorias.component').then((c) => c.CategoriasComponent),
          ...
          data: {
            description: 'Modelos de rótulación y cartelería para tiendas, hoteles, oficinas, etc. Encuentra el modelo de letrero que más se adapte a tus necesidades.',
      ...
      },
      {
        path: 'nosotros', loadComponent: () =>
          ...
          data: {
            description: 'Soluciones de señalización para comercios, edificios y eventos de todo tipo, así como letras corpóreas y materiales para rótulos. Conócenos.',
            image: 'https://res.cloudinary.com/dxuseyfxa/image/upload/f_auto/v1736523883/image_20250110164118_e4c5e4.webp',
          }
      },
      {
        path: 'casos-de-exito', loadComponent: () =>
          import('./pages/casos/casos.component').then(
            (c) => c.CasosComponent
          ),
          title: 'Casos de éxito de Rótulos Learoy',
          data: {
            description: 'Ejemplos de rótulos llamativos. Ideas para letreros para fachadas o interior. Pide presupuesto a medida y con entrega rápida.',
            image: 'https://res.cloudinary.com/dxuseyfxa/image/upload/v1742571010/led-neon-personalizado-centros-comerciales-rotulos-learoy_qd2rlf.webp',
          }
      },
      {
        path: 'contacto', loadComponent: () =>
          ...
          data: {
            description: 'Contacto Rótulos Learoy, proveedor de rotulación de confianza. Si buscas un letrero o cartel de cualquier tipo, haz tu consulta.',
           image: 'https://res.cloudinary.com/dxuseyfxa/image/upload/v1742550802/rotulo-luminoso-learoy_dgqanb.webp'
          }
      },
      {
        path: 'politica-de-cookies', loadComponent: () =>
      ...
      {
        path: 'politica-de-privacidad', loadComponent: () =>
          import('./pages/politica-de-privacidad/politica-de-privacidad.component').then(
            (c) => c.PoliticaDePrivacidadComponent
          ),
        title: 'Política de privacidad | Rótulos Learoy'        
      },
      {
        path: 'aviso-legal', loadComponent: () =>
    ...
    //   },
    //   {
    //     path: 'admin-panel', loadComponent: () =>
    ...
    //   },
      {
        path: ':category', loadComponent: () =>
          import('./pages/detalle-categoria-principal/detalle-categoria-principal.component').then(
            (c) => c.DetalleCategoriaPrincipalComponent
          ),
      },
      {
